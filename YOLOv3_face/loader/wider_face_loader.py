...
class WiderFaceDataLoader:
    def __init__(self, train_image_dir, test_image_dir, train_annotation_path, test_annotation_path,
        batch_size=128, train_transform=None, test_transform=None, num_workers=4):
        #set the dataLoader
